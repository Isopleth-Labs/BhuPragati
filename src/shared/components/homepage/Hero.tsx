    ...
    >
      <div className="min-h-[300px] px-[22px] pt-[22px] pb-[18px] bg-[rgba(8,12,20,0.35)] border border-white/[0.08] rounded-[10px] shadow-[0_12px_32px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-[20px] transition-all duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 hover:bg-[rgba(8,12,20,0.45)] hover:border-white/[0.15] hover:shadow-[0_20px_48px_rgba(0,0,0,0.4),0_0_32px_rgba(255,255,255,0.02),inset_0_1px_0_rgba(255,255,255,0.1)]">
        ...
        {metrics.map((metric, index) => (
          <div
            className="pb-[14px] mb-5 border-b border-white/[0.08] mb-0"
            key={metric.label}
          >
            ...
            <p className="flex items-baseline justify-between gap-3 text-[22px] font-medium leading-[1.12] text-white">
              ...
              >
                ...
                <span
                  className={
                    metric.trend === "down"
                      ? "h-0 w-0 border-x-[4px] border-x-transparent border-t-[6px] border-t-current"
                      : "h-0 w-0 border-x-[4px] border-x-transparent border-b-[6px] border-b-current"
                  }
                  aria-hidden="true"
                />
              </span>
...
function Hero() {
  return (
    <section
      className="relative box-border flex items-center justify-center h-screen min-h-screen px-[clamp(30px,4.8vw,78px)]  pb-[110px] overflow-hidden bg-black isolate"
      id="top"
    >
      ...
      <div className="relative z-[5] flex flex-col items-center max-w-[780px] mt-[clamp(76px,20vh,172px)] text-center">
        ...
        <div className="mt-[52px]">
          <Link
            to="/state-map"
            className="inline-flex min-h-[76px] min-w-[400px] items-center justify-center gap-3.5 rounded-lg border border-[rgba(255,221,126,0.78)] bg-gradient-to-b from-[#ffd76a] to-[#e7aa25] px-16 text-[22px] font-extrabold tracking-[0.02em] uppercase text-[#08101c] shadow-[0_10px_34px_rgba(247,198,75,0.34),inset_0_1px_0_rgba(255,255,255,0.36)] transition-all hover:-translate-y-px hover:shadow-[0_15px_44px_rgba(247,198,75,0.44),inset_0_1px_0_rgba(255,255,255,0.42)]"
          >
            <span>ENTER EARTH NETWORK</span>
            <span className="h-2 w-2 rotate-45 border-t-2 border-r-2 border-current" />
          </Link>
        </div>
        <a
          href="#explore"
        ...
        >
          ...
          <span
            aria-hidden="true"
            className="
				relative h-[17px] w-[17px] rounded-full border border-current
    			before:absolute
    			before:top-[5px]
    			before:left-[5px]
    			before:h-[5px]
