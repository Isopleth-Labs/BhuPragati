...
import { DISTRICT_FILL_LAYER, DISTRICT_SOURCE } from "@/shared/selectors"
...
export function DistrictSelectionController({
	...
	const onDistrictClickRef =
		useRef<(districtId: string) => void>(onDistrictClick)
	useEffect(() => {
	...
	useEffect(() => {
		...
		function handleMouseMove(e: MapLayerMouseEvent) {
			...
			m.setFeatureState({ source: DISTRICT_SOURCE, id }, { hover: true })
		...
		function handleClick(e: MapLayerMouseEvent) {
			...
			m.setFeatureState({ source: DISTRICT_SOURCE, id }, { selected: true })
