...
export const IndiaIcon = () => (
  <svg viewBox="20 20 560 650" fill="rgba(140, 224, 255, 0.15)" stroke="currentColor" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round">
    ${map.locations.map(l => `<path d="${l.path}" />`).join('\n    ')}
    <circle cx="200" cy="300" r="12" fill="currentColor" stroke="none" />
    <circle cx="350" cy="250" r="12" fill="currentColor" stroke="none" />
    <circle cx="280" cy="450" r="12" fill="currentColor" stroke="none" />
...
export const StateIcon = () => (
  <svg viewBox="85 360 180 150" fill="rgba(140, 224, 255, 0.15)" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round">
    <path d="${mh.path}" />
    <circle cx="150" cy="420" r="4" fill="currentColor" stroke="none" />
    <circle cx="220" cy="450" r="4" fill="currentColor" stroke="none" />
...
export const DistrictIcon = () => (
  <svg viewBox="112 500 20 24" fill="rgba(140, 224, 255, 0.15)" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="${goa.path}" />
    <circle cx="120" cy="510" r="0.6" fill="currentColor" stroke="none" />
