...
const HEALTHCARE_METRICS = [
      { label: "Total Facilities", value: "1,48,734", change: "+2.4%", trend: "up" as const },
      { label: "Population Coverage", value: "92.6%", change: "+1.8%", trend: "up" as const, progress: 82 },
      { label: "Critical Districts", value: "284", change: "-3.2%", trend: "down" as const },
]

const FLOOD_METRICS = [
      { label: "At Risk Districts", value: "312", change: "+5.6%", trend: "alert" as const },
      { label: "Affected Population", value: "2.8M", change: "+7.3%", trend: "alert" as const, progress: 68 },
      { label: "Rainfall (24h)", value: "118.6 mm", change: "+12.4%", trend: "alert" as const },
]

type MetricTrend = "up" | "down" | "alert"
interface Metric { label: string; value: string; change: string; trend: MetricTrend; progress?: number }
              ...
              >
                      ...
                      >
                              ...
                              {metrics.map((metric, index) => (
                                      <div key={metric.label} className="pb-[14px] mb-5 border-b border-[rgba(255,255,255,0.08)] last-of-type:mb-0">
                                              <p className="mb-[6px] text-[9px] font-bold text-[#7f91a9] uppercase">{metric.label}</p>
                                              <p className="flex gap-3 items-baseline justify-between text-[22px] font-medium leading-[1.12] text-white max-[1120px]:text-[20px]">
                                                      ...
                                                      <span
                                                              className={cn(
                                                                      ...
                                                                      metric.trend === "alert" ? "text-[#ff654f]" : "text-[#5de582]",
                                                              )}
                                                      >
                                                              {metric.change}
                                                              <span
                                              ...
                                              {metric.progress !== undefined && (
                                                      <span aria-hidden="true" className="block h-[5px] mt-[13px] overflow-hidden bg-[rgba(116,140,169,0.25)] rounded-full">
                                                              <span
                              ...
                              >
                                      {linkLabel}
                                      <span aria-hidden="true" className="inline-block w-[7px] h-[7px] border-t border-r border-current rotate-45" />
                              </a>
                      </div>
              </aside>
      )
      ...
      return (
              ...
              >
                      ...
                      <div
                              ...
                              aria-hidden="true"
                      >
                              <span className="text-[9px] font-bold text-[#9fb0c8] uppercase tracking-[0.15em]">Scroll to explore</span>
                              <div className="relative w-px h-6 overflow-hidden bg-[linear-gradient(to_bottom,#9fb0c8,transparent)]">
                                      <span className="absolute top-0 left-0 w-full h-2 bg-[#6ad1ff]" style={{ animation: "scrollLinePulse 2s cubic-bezier(0.16,1,0.3,1) infinite" }} />
                              </div>
                      </div>
